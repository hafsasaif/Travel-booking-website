                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            ...
                            <p>Note: If the customer is less than 12 years old, Inconsistent with him</p>
                        </h1>
...
//+____________________________________________________
                        ...
                        }else if($meal=="Full Board")
                        {
                          $type_of_meal=$type_of_bed * 4;
														...
														$ttot = $type_of_season * $days * $nroom;
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`,`age`,`city`, `season`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$age','$city','$season','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days')";

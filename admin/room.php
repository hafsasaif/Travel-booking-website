    ...
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                      <li><a href="index.php"><i class="fa fa-user fa-fw"></i>ADMINISTRATOR</a>
                      </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">  <img  src="https://5zznly.com/p/2020/11/nO75f_logo.png" alt="Avatar" style="width:200px">
                ...
                <div class="col-md-5 col-sm-5">
                    <div class="panel panel-primary">
						...
						<form name="form" method="post">
                          ...
                          <option value="Superior Room">Campsite Huse</option>

...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<span><img  src="https://5zznly.com/p/2020/11/nO75f_logo.png" alt="Avatar" style="width:200px">
		</header>
		<article>
			<h1></h1>
			<address >
			...
			<table >
				<tr>
					...
					<td>Age  : -  <?php echo $age; ?> </td>
						<td>Customer Sex : -  <?php echo $Sex; ?> </td>
					<tr>
					...
					<tr>
						<td>The city Customer need : -  <?php echo $city; ?> </td>
					</tr>
				</table>
				<br>
				<br>
